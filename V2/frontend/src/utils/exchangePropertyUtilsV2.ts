 ...
 */
export const exchangePropertyAlgorithm = (nodes: Node[], edges: Edge[]): ExchangeV2Step[] => {
    const nodeCount = nodes.length;
    const steps: ExchangeV2Step[] = [];
    ...
    const forbiddenEdges = new Set<string>(); // pour éviter de réutiliser une arête déjà retirée
