...
export const primAlgorithm = (nodes, edges) => {
    ...
    steps.push({
        ...
        explanation: `On commence la composante en construction en y mettant ${indexToNode[0]}.`
    });
    ...
    for (let k = 0; k < nodeCount - 1; k++) {
        ...
        steps.push({
            ...
            componentColor: componentColor,
            explanation: `Ajout de l'arête ${sourceId}-${targetId} (poids : ${edge.data.weight}) car c'est l'arête de poids minimal reliant la composante en construction à un sommet non visité. Le sommet ${targetId} rejoint maintenant la composante en construction.`
        });
    }
