...
import BoruvkaVisualization from './BoruvkaVisualization';
import '../../../styles/pages/ArbreCouvrant/BoruvkaPage.css';
...
const BoruvkaPage = () => {
    ...
    return (
        <div className="tree-mode-container">
            ...
            <h2 className="tree-mode-title">Visualisation de l'algorithme de Boruvka</h2>
            <div className="tree-mode-top-bar boruvka-vertical">
                ...
                <div className="boruvka-visualization-infos">
                    <BoruvkaVisualization graph={graph} cyRef={cyRef} />
                </div>
            </div>
            <div className="boruvka-graph-centered">
