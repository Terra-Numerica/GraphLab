...
import KruskalVisualization from './KruskalVisualization';
import '../../../styles/pages/ArbreCouvrant/KruskalPage.css';
...
const KruskalPage = () => {
    ...
    return (
        <div className="tree-mode-container">
            ...
            <h2 className="tree-mode-title">Visualisation de l'algorithme de Kruskal</h2>
            <div className="tree-mode-top-bar kruskal-vertical">
                ...
                <div className="kruskal-visualization-infos">
                    <KruskalVisualization graph={graph} cyRef={cyRef} />
                </div>
            </div>
            <div className="kruskal-graph-centered">
